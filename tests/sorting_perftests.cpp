...
TEST(insertion_sort_test, sorting_performance) {
	sorting_performance_test(insertion_sort, "insertion sort", 10000, 2);//50000
}
TEST(merge_sort_test, sorting_performance) {
    sorting_performance_test(merge_sort, "merge sort", 10e+5, 4);//10e+6
}
TEST(quick_sort_test, sorting_performance) {
	sorting_performance_test(quick_sort, "quick sort", 10e+5, 3);
}
