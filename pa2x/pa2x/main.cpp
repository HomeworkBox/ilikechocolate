...
//  pa2x
//
//  Created by Felicia Truong,  Tyler Weimin Ouyang on 8/16/14.
...
int main(int argc, const char * argv[]) {
    int testarray[]={ 5,2,9,7,10,6,8,12, 3,1}, a2[]={ 10, 5, 1, 4, 5, 7, 2, 3, 6, 8, 9, 5, 5, 1, 4, 5, 7, 2, 3, 6, 8, 9,101,68,46,54,3};
